 ...
 */
class ExampleGameView extends GLSurfaceView {
    private static String TAG = "ExampleGameView";
    private static final boolean DEBUG = false;

    public ExampleGameView(Context context) {
        super(context);
        init(false, 0, 0);
    }

    public ExampleGameView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
