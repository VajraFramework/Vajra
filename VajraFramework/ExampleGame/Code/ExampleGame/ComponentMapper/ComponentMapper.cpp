...
Component* ComponentMapper::AddNewComponentToGameObjectByComponentName(GameObject* gameObject, std::string componentName) {
	...
	if (componentName == "TriggerGridZoneActivate") {
		TriggerGridZoneActivate* component = gameObject->GetComponent<TriggerGridZoneActivate>();
		if (component == nullptr) { component = gameObject->AddComponent<TriggerGridZoneActivate>(); }
		return component;
	}
